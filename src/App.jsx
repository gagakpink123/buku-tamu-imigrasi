            ...
            {adminTab === 'drive' && (
              <div className="bg-white/90 border border-white/60 rounded-3xl p-6 sm:p-7 space-y-5 shadow-sm">
                <div>
                  ...
                  <p className="text-xs text-slate-500 font-medium mt-0.5">Masukkan URL Web App dari Google Apps Script agar setiap tamu otomatis masuk ke Spreadsheet lengkap dengan foto dan tanda tangan kompresi.</p>
                </div>
                <div className="space-y-1.5">
